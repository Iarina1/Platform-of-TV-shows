...
public final class Constants {
    ...
    public static final String IS_IN_FAVORITE = " is already in favourite list";
    public static final String ADD_TO_FAVORITE = " was added as favourite";
    ...
    public static final String IS_RATED = " is already rated";
    public static final String HAS_BEEN_RATED = " has been already rated";
